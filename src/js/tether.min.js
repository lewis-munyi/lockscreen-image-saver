!(function(t, e) {
	...
	var O = null,
		...
		A = function() {
			...
			(t && document.body.contains(t)) ||
				((t = document.createElement("div")), t.setAttribute("data-tether-id", E()), a(t.style, { top: 0, left: 0, position: "absolute" }), document.body.appendChild(t), (O = t));
		...
		var t = null,
			...
			i = function n() {
				return "undefined" != typeof e && e > 16
					...
					: void (("undefined" != typeof t && m() - t < 10) || (null != o && (clearTimeout(o), (o = null)), (t = m()), Y(), (e = m() - t)));
			};
	...
	var L = { center: "center", left: "right", right: "left" },
		...
		F = function(t, e) {
			var o = t.left,
				i = t.top;
			return "auto" === o && (o = L[e.left]), "auto" === i && (i = D[e.top]), { left: o, top: i };
		},
		H = function(t) {
			var e = t.left,
				o = t.top;
			return "undefined" != typeof X[t.left] && (e = X[t.left]), "undefined" != typeof X[t.top] && (o = X[t.top]), { left: e, top: o };
		},
		N = function(t) {
			var e = t.split(" "),
				o = k(e, 2),
						...
						value: function() {
							...
							if ("scroll-handle" === this.targetModifier) {
								...
								var a = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - s,
									...
									f = 0;
								a < 408 && this.target === document.body && (f = -11e-5 * Math.pow(a, 2) - 0.00727 * a + 22.58), this.target !== document.body && (e.height = Math.max(e.height, 24));
							...
							i.forEach(function(t) {
								...
								P(function() {
									"undefined" != typeof o._addAttachClasses &&
										(u(o.element, o._addAttachClasses, r), o.options.addTargetClasses !== !1 && u(o.target, o._addAttachClasses, r), delete o._addAttachClasses);
								});
						}
					},
					{
						...
						value: function() {
							...
							if (this.enabled) {
								...
								var h = this.cache("target-bounds", function() {
									...
									d = h,
									p = y(H(this.attachment), { width: a, height: f }),
									u = y(H(o), d),
								...
								var x = {
										page: { top: b, left: m },
										viewport: { top: b - pageYOffset, bottom: pageYOffset - b - f + innerHeight, left: m - pageXOffset, right: pageXOffset - m - a + innerWidth }
									},
									A = this.target.ownerDocument,
									T = A.defaultView,
									S = void 0;
								return (
									T.innerHeight > A.documentElement.clientHeight && ((S = this.cache("scrollbar-size", s)), (x.viewport.bottom -= S.height)),
									T.innerWidth > A.documentElement.clientWidth && ((S = this.cache("scrollbar-size", s)), (x.viewport.right -= S.width)),
		...
		position: function(t) {
			...
			return (
				this.options.constraints.forEach(function(t) {
					...
					var w = b(e, n);
					("target" !== d && "both" !== d) || (o < w[1] && "top" === v.top && ((o += p), (v.top = "bottom")), o + f > w[3] && "bottom" === v.top && ((o -= p), (v.top = "top"))),
						"together" === d &&
							("top" === v.top &&
								("bottom" === y.top && o < w[1]
									? ((o += p), (v.top = "bottom"), (o += f), (y.top = "top"))
									: "top" === y.top && o + f > w[3] && o - (f - p) >= w[1] && ((o -= f - p), (v.top = "bottom"), (y.top = "bottom"))),
							"bottom" === v.top &&
								("top" === y.top && o + f > w[3]
									? ((o -= p), (v.top = "top"), (o -= f), (y.top = "bottom"))
									: "bottom" === y.top && o < w[1] && o + (2 * f - p) <= w[3] && ((o += f - p), (v.top = "top"), (y.top = "top"))),
							"middle" === v.top && (o + f > w[3] && "top" === y.top ? ((o -= f), (y.top = "bottom")) : o < w[1] && "bottom" === y.top && ((o += f), (y.top = "top")))),
						("target" !== h && "both" !== h) || (i < w[0] && "left" === v.left && ((i += c), (v.left = "right")), i + l > w[2] && "right" === v.left && ((i -= c), (v.left = "left"))),
						"together" === h &&
							(i < w[0] && "left" === v.left
								? "right" === y.left
								...
								: "center" === v.left && (i + l > w[2] && "left" === y.left ? ((i -= l), (y.left = "right")) : i < w[0] && "right" === y.left && ((i += l), (y.left = "left")))),
						("element" !== d && "both" !== d) || (o < w[1] && "bottom" === y.top && ((o += f), (y.top = "top")), o + f > w[3] && "top" === y.top && ((o -= f), (y.top = "bottom"))),
						("element" !== h && "both" !== h) ||
