				...
				preFilter: {
					...
					PSEUDO: function(e) {
						...
						return X.CHILD.test(e[0])
							...
							: (e[3]
									? (e[2] = e[4] || e[5] || "")
									: n && U.test(n) && (t = a(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
							  e.slice(0, 3));
					}
				},
				filter: {
										...
										if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
											...
											while ((d = (++p && d && d[g]) || (b = p = 0) || h.pop()))
												if (
													...
													++b &&
													(m && ((c = (f = d[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [C, b]), d === t)
												)
													break;
			...
			(a = oe.tokenize = function(e, t) {
				...
				while (u) {
					(n && !(i = F.exec(u))) || (i && (u = u.slice(i[0].length) || u), s.push((o = []))),
						(n = !1),
						(i = z.exec(u)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace($, " ") }), (u = u.slice(n.length)));
	...
	function fe(e, t) {
		for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
			(r = e[o]).style &&
				((n = r.style.display),
				t
					? ("none" === n && ((i[o] = K.get(r, "display") || null), i[o] || (r.style.display = "")), "" === r.style.display && ae(r) && (i[o] = ce(r)))
				...
				while ((o = u[n++]) && !t.isPropagationStopped()) {
					...
					while ((a = o.handlers[r++]) && !t.isImmediatePropagationStopped())
						(t.rnamespace && !t.rnamespace.test(a.namespace)) ||
							((t.handleObj = a),
							(t.data = a.data),
							void 0 !== (i = ((w.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, s)) && !1 === (t.result = i) && (t.preventDefault(), t.stopPropagation()));
				}
				...
				for (c = u[u.length - 1].ownerDocument, w.map(u, Pe), f = 0; f < s; f++)
					(l = u[f]),
						he.test(l.type || "") &&
							...
							w.contains(c, l) &&
							(l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(l.src) : m(l.textContent.replace(je, ""), c, l));
		}
		return e;
	}
	function Be(e, t, n) {
